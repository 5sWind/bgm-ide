...
function testGitHubImport (browser, callback) {
  contractHelper.addFile(browser, 'Untitled4.sol', sources[3]['browser/Untitled4.sol'], () => {
    browser.pause(10000)
    .perform(function () {
      contractHelper.verifyContract(browser, ['browser/Untitled4.sol:test7', 'github.com/bgmchain/ens/contracts/AbstractENS.sol:AbstractENS', 'github.com/bgmchain/ens/contracts/ENS.sol:ENS'], function () {
        callback(null, browser)
      })
    })
  })
...
var sources = [
  ...
  {
    'browser/Untitled4.sol': {content: 'import "github.com/bgmchain/ens/contracts/ENS.sol"; contract test7 {}'},
    'github.com/bgmchain/ens/contracts/ENS.sol': {content: ENS}
  },
  {
    'browser/Untitled4.sol': {content: 'import "github.com/bgmchain/ens/contracts/ENS.sol"; contract test7 {}'},
    'github.com/bgmchain/ens/contracts/ENS.sol': {content: ENS},
    'github.com/bgmchain/ens/contracts/AbstractENS.sol': {content: abstractENS}
  },
  {
