...
function run () {
  ...
  if (window.location.hostname === 'yann300.github.io') {
    modalDialogCustom.alert('This UNSTABLE ALPHA branch of Remix has been moved to http://bgmchain.github.io/remix-live-alpha.')
  } else if (window.location.hostname === 'remix-alpha.bgmchain.org' ||
  (window.location.hostname === 'bgmchain.github.io' && window.location.pathname.indexOf('/remix-live-alpha') === 0)) {
    modalDialogCustom.alert(`Welcome to the Remix alpha instance. Please use it to try out latest features. But use preferably https://remix.bgmchain.org for any production work.`)
  } else if (window.location.protocol.indexOf('http') === 0 &&
  window.location.hostname !== 'remix.bgmchain.org' &&
  window.location.hostname !== 'localhost' &&
  window.location.hostname !== '127.0.0.1') {
    modalDialogCustom.alert(`The Remix IDE has moved to http://remix.bgmchain.org.\n
This instance of Remix you are visiting WILL NOT BE UPDATED.\n
Please make a backup of your contracts and start using http://remix.bgmchain.org`)
  }
  ...
  self._components.compiler.event.register('compilerLoaded', this, function (version) {
    ...
    if (queryParams.get().context) {
      ...
      () => {
        modalDialogCustom.confirm(null, 'Are you sure you want to connect to an bgmchain node?', () => {
          if (!endPointUrl) {
