...
function confirmDialog (tx, amount, gasEstimation, self, newGasPriceCb, initialParamsCb) {
  ...
  <div>
    ...
    <div class=${css.txInfoBox}>
      ...
      <div>Amount: ${amount} Bgmchain</div>
      <div>Gas estimation: ${gasEstimation}</div>
      <div>Gas limit: ${tx.gas}</div>
      <div>Gas price: <input id='gasprice' oninput=${onGasPriceChange} /> Gwei <span> (visit <a target='_blank' href='https://bgmgasstation.info'>bgmgasstation.info</a> to get more info about gas price)</span></div>
