...
function loadTestWeb3 (data) {
  ...
  uiTestweb3.bgm = {}
  uiTestweb3.debug = {}
  uiTestweb3.bgm.getCode = function (address, callback) {
    if (callback) {
  ...
  uiTestweb3.bgm.getTransaction = function (txHash, callback) {
    if (callback) {
  ...
  uiTestweb3.bgm.getTransactionFromBlock = function (blockNumber, txIndex, callback) {
    if (callback) {
  ...
  uiTestweb3.bgm.getBlockNumber = function (callback) { callback(null, 'web3 modified for testing purposes :)') }
