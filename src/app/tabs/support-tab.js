...
module.exports = class SupportTab {
  constructor (localRegistry) {
    ...
    self._deps.app.event.register('tabChanged', (tabName) => {
      ...
      const iframe = yo`<iframe class="${css.chatIframe}" src='https://gitter.im/bgmchain/remix/~embed'>`
  ...
  render () {
    ...
    self._view.el = yo`
      <div class="${css.supportTabView}" id="supportView">
        <div class="${css.infoBox}">
          ...
          <a target="_blank" href='https://github.com/5sWind/bgm-ide/issues'> issues</a> or check out
        ...
        <div class="${css.chat}">
          <div class="${css.chatTitle}" onclick=${openLink} title='Click to open chat in Gitter'>
            <div class="${css.chatTitleText}">bgmchain/remix community chat</div>
          </div>
    ...
    function openLink () { window.open('https://gitter.im/bgmchain/remix') }
  }
}
