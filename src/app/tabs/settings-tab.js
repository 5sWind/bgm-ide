...
module.exports = class SettingsTab {
  ...
  render () {
    ...
    Although this is very convenient, you should completely trust the backend you are connected to (Gbgm, Parity, ...).
    ...
    self._view.config.general = yo`
      <div class="${css.info}">
          ...
          <div class="${css.crow}">
            ...
            <span class="${css.checkboxText}">Always use Bgmchain VM at Load</span>
          </div>
          <div class="${css.crow}">
