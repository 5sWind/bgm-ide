...
var getDetails = function (contractName, contract, source) {
  ...
  if (contract.evm.bytecode.object) {
    ...
    detail.web3Deploy = gbgmDeploy(contractName.toLowerCase(), contract.abi, contract.evm.bytecode.object)
...
var gbgmDeploy = function (contractName, jsonInterface, bytecode) {
  var code = ''
  ...
  code += 'var ' + contractName + 'Contract = web3.bgm.contract(' + JSON.stringify(jsonInterface).replace('\n', '') + ');' +
