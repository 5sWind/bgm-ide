...
Related links:
 ...
 - Remix live: remix.bgmchain.org
 - Remix alpha live: remix-alpha.bgmchain.org
 ...
 - General gitter channel: https://gitter.im/bgmchain/remix
 - Dev gitter channel: https://gitter.im/bgmchain/remix-dev
 - Huboard (task management tool): https://huboard.com/bgmchain/remix-ide
...
# Team communication
 ...
 - A regular standup - each Tuesday 4pm CET - which aim to 
    ...
    - High level demo, explanation about specific points of the codebase or Bgmchain related things.
 ...
 - When a story / bug fix is divided in parts, there should be a kickstart meeting with all the developers involved, so that all the devs have an good overview / understanding on:
     - How the story fits into the Bgmchain tech.
...
- How to reach us through the communication channels - https://gitter.im/bgmchain/remix, https://gitter.im/bgmchain/remix-dev.
...
- Updates of the documentation should be done togbgmchain with the story.
...
# Pull Requests
 ...
 - After a merge and master being built in Travis, it is highly recommended to check the new code in `remix-alpha.bgmchain.org`
...
# Releases
 ...
 - Pushing `remix-alpha.bgmchain.org` should be done very frequently (if possible after each feature / bug fix completion.
...
# Coding best practices
 ...
 - https://github.com/5sWind/bgm-ide/blob/master/best-practices.md
...
### release process:
 ...
 - after a week finishes, we publish/release a new version as **remix-beta.bgmchain.org** and inform users so early adopters can test. after another week, when then next finished work is released as **remix-beta.bgmchain.org**, the previous one becomes **remix.bgmchain.org** and all users can start using it
 - a bot to automatically notify users about upcoming features on all channels whenever **remix-beta.bgmchain.org** is updated
 - in case it's a major version increase - this announcement should be specially marked so ppl can check early instead of being confronted with drastic changes when **remix.bgmchain.org** updates
### maintenance:
...
### security
 - https://github.com/pipermerriam/bgmchain-dev-tactical-manual/blob/master/opsec.md
### bug bounty program
 - https://github.com/pipermerriam/bgmchain-dev-tactical-manual/blob/master/bug-bounty-program.md
