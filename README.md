[![CircleCI](https://circleci.com/gh/bgmchain/remix-ide.svg?style=svg)](https://circleci.com/gh/bgmchain/remix-ide)
...
Remix is a browser-based compiler and IDE that enables users to build **Bgmchain contracts with Solidity language** and to debug transactions.

To try it out, visit [https://remix.bgmchain.org](https://remix.bgmchain.org).

https://github.com/5sWind/bgm-ide/releases also gives others ways to use Remix locally. Please check it out.
...
```bash
git clone https://github.com/5sWind/bgm-ide.git
git clone https://github.com/5sWind/bgm.git # only if you plan to link remix and remix-ide repositories and develop on it.
cd remix-ide
npm install
...
Most of the the time working with other modules (like debugger etc.) hosted in the [Remix repository](https://github.com/5sWind/bgm) is not needed.

### Troubleshooting building

Some things to consider if you have trouble building the package:

- Make sure that you have the correct version of `node`, `npm` and `nvm`. You can find the version that is tested on Travis CI by looking at the log in the [build results](https://travis-ci.org/bgmchain/remix-ide).
